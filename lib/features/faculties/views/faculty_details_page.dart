        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.account_balance_rounded, size: 16, color: AppColors.textGrey.withOpacity(0.5)),
                  ...
                  const SizedBox(width: 8),
                  Text('Faculty Details', style: AppTextStyles.bodySmall.copyWith(color: AppColors.primary, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
