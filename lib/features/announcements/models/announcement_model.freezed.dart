...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,content,type,linkUrl,imageUrl,scopeType,scopeId,academicTermId,createdAt,updatedAt,createdByUserId,authorName);
...
@useResult
$Res call({
 String? id, String title, String content, String type,@JsonKey(name: 'link_url') String? linkUrl,@JsonKey(name: 'image_url') String? imageUrl,@JsonKey(name: 'scope_type') String scopeType,@JsonKey(name: 'scope_id') String scopeId,@JsonKey(name: 'academic_term_id') String academicTermId,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt,@JsonKey(name: 'created_by_user_id') String? createdByUserId,@JsonKey(includeFromJson: true, includeToJson: false) String? authorName
});
...
/// Create a copy of AnnouncementModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = null,Object? content = null,Object? type = null,Object? linkUrl = freezed,Object? imageUrl = freezed,Object? scopeType = null,Object? scopeId = null,Object? academicTermId = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? createdByUserId = freezed,Object? authorName = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String title,  String content,  String type, @JsonKey(name: 'link_url')  String? linkUrl, @JsonKey(name: 'image_url')  String? imageUrl, @JsonKey(name: 'scope_type')  String scopeType, @JsonKey(name: 'scope_id')  String scopeId, @JsonKey(name: 'academic_term_id')  String academicTermId, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'created_by_user_id')  String? createdByUserId, @JsonKey(includeFromJson: true, includeToJson: false)  String? authorName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AnnouncementModel() when $default != null:
return $default(_that.id,_that.title,_that.content,_that.type,_that.linkUrl,_that.imageUrl,_that.scopeType,_that.scopeId,_that.academicTermId,_that.createdAt,_that.updatedAt,_that.createdByUserId,_that.authorName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String title,  String content,  String type, @JsonKey(name: 'link_url')  String? linkUrl, @JsonKey(name: 'image_url')  String? imageUrl, @JsonKey(name: 'scope_type')  String scopeType, @JsonKey(name: 'scope_id')  String scopeId, @JsonKey(name: 'academic_term_id')  String academicTermId, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'created_by_user_id')  String? createdByUserId, @JsonKey(includeFromJson: true, includeToJson: false)  String? authorName)  $default,) {final _that = this;
switch (_that) {
case _AnnouncementModel():
return $default(_that.id,_that.title,_that.content,_that.type,_that.linkUrl,_that.imageUrl,_that.scopeType,_that.scopeId,_that.academicTermId,_that.createdAt,_that.updatedAt,_that.createdByUserId,_that.authorName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String title,  String content,  String type, @JsonKey(name: 'link_url')  String? linkUrl, @JsonKey(name: 'image_url')  String? imageUrl, @JsonKey(name: 'scope_type')  String scopeType, @JsonKey(name: 'scope_id')  String scopeId, @JsonKey(name: 'academic_term_id')  String academicTermId, @JsonKey(name: 'created_at')  DateTime? createdAt, @JsonKey(name: 'updated_at')  DateTime? updatedAt, @JsonKey(name: 'created_by_user_id')  String? createdByUserId, @JsonKey(includeFromJson: true, includeToJson: false)  String? authorName)?  $default,) {final _that = this;
switch (_that) {
case _AnnouncementModel() when $default != null:
return $default(_that.id,_that.title,_that.content,_that.type,_that.linkUrl,_that.imageUrl,_that.scopeType,_that.scopeId,_that.academicTermId,_that.createdAt,_that.updatedAt,_that.createdByUserId,_that.authorName);case _:
  return null;
...
class _AnnouncementModel implements AnnouncementModel {
  const _AnnouncementModel({this.id, required this.title, required this.content, this.type = 'General', @JsonKey(name: 'link_url') this.linkUrl, @JsonKey(name: 'image_url') this.imageUrl, @JsonKey(name: 'scope_type') required this.scopeType, @JsonKey(name: 'scope_id') required this.scopeId, @JsonKey(name: 'academic_term_id') required this.academicTermId, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt, @JsonKey(name: 'created_by_user_id') this.createdByUserId, @JsonKey(includeFromJson: true, includeToJson: false) this.authorName});
...
/// Create a copy of AnnouncementModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? title = null,Object? content = null,Object? type = null,Object? linkUrl = freezed,Object? imageUrl = freezed,Object? scopeType = null,Object? scopeId = null,Object? academicTermId = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? createdByUserId = freezed,Object? authorName = freezed,}) {
