...
@JsonKey(name: 'auth_id') String get authId; String get email;@JsonKey(name: 'first_name') String? get firstName;@JsonKey(name: 'last_name') String? get lastName;@JsonKey(name: 'student_id_number') String get schoolId;@JsonKey(name: 'faculty_id') String? get facultyId;@JsonKey(name: 'program_id') String? get programId;@JsonKey(name: 'campus_id') String? get campusId;@JsonKey(name: 'year') int? get yearLevel;@JsonKey(name: 'profile_photo_url') String? get avatarUrl;@JsonKey(name: 'organization_ids') List<String> get organizationIds;/// Derived or primary role
 ...
 String? get facultyName; String? get programName; String? get campusName; String? get facultyCode; String? get programCode;@JsonKey(name: 'expired_at') DateTime? get expiredAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,authId,email,firstName,lastName,schoolId,facultyId,programId,campusId,yearLevel,avatarUrl,const DeepCollectionEquality().hash(organizationIds),role,status,createdAt,joinedAt,facultyName,programName,campusName,facultyCode,programCode,expiredAt]);

@override
String toString() {
  return 'UserModel(id: $id, authId: $authId, email: $email, firstName: $firstName, lastName: $lastName, schoolId: $schoolId, facultyId: $facultyId, programId: $programId, campusId: $campusId, yearLevel: $yearLevel, avatarUrl: $avatarUrl, organizationIds: $organizationIds, role: $role, status: $status, createdAt: $createdAt, joinedAt: $joinedAt, facultyName: $facultyName, programName: $programName, campusName: $campusName, facultyCode: $facultyCode, programCode: $programCode, expiredAt: $expiredAt)';
}
...
as String?,facultyCode: freezed == facultyCode ? _self.facultyCode : facultyCode // ignore: cast_nullable_to_non_nullable
as String?,programCode: freezed == programCode ? _self.programCode : programCode // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _UserModel() when $default != null:
return $default(_that.id,_that.authId,_that.email,_that.firstName,_that.lastName,_that.schoolId,_that.facultyId,_that.programId,_that.campusId,_that.yearLevel,_that.avatarUrl,_that.organizationIds,_that.role,_that.status,_that.createdAt,_that.joinedAt,_that.facultyName,_that.programName,_that.campusName,_that.facultyCode,_that.programCode,_that.expiredAt);case _:
  return orElse();
...
@override final  String? programCode;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,authId,email,firstName,lastName,schoolId,facultyId,programId,campusId,yearLevel,avatarUrl,const DeepCollectionEquality().hash(_organizationIds),role,status,createdAt,joinedAt,facultyName,programName,campusName,facultyCode,programCode,expiredAt]);
