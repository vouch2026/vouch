          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Spacer(),
                _buildTimeRow(context, Icons.login_rounded, 'Time in:', TimeFormatter.formatDbTimeTo12Hour(widget.event.timeInStart)),
                const SizedBox(height: AppSpacing.xs),
                _buildTimeRow(context, Icons.logout_rounded, 'Time out:', TimeFormatter.formatDbTimeTo12Hour(widget.event.timeOutStart)),
              ],
            ),
          ),
        ),
