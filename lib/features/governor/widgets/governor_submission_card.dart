        ...
        child: Card(
          ...
          child: InkWell(
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => PaymentDetailsPage(payment: widget.submission),
              ),
            ),
            child: Padding(
                  ...
                  SizedBox(
                    ...
                    child: FilledButton(
                      ...
                      style: FilledButton.styleFrom(
                        backgroundColor: (status == 'Pending' && widget.onApprove != null)
                            ? AppColors.accent
                            : theme.colorScheme.primary.withOpacity(0.05),
                        foregroundColor: (status == 'Pending' && widget.onApprove != null)
                            ? AppColors.primary
                      ...
                      child: Text(
                        (status == 'Pending' && widget.onApprove != null) ? 'Verify Payment' : 'View Details',
                        style: AppTextStyles.labelLarge.copyWith(
                          fontWeight: FontWeight.bold,
                          color: (status == 'Pending' && widget.onApprove != null)
                              ? AppColors.primary
                              : theme.colorScheme.primary,
                        ),
                      ),
