...
class AcademicHierarchyOrgFilter extends StatefulWidget {
  ...
  const AcademicHierarchyOrgFilter({
    super.key,
  ...
  @override
  State<AcademicHierarchyOrgFilter> createState() => _AcademicHierarchyOrgFilterState();
}

class _AcademicHierarchyOrgFilterState extends State<AcademicHierarchyOrgFilter> {
  ...
  int _getCampusOrgCount(String campusId) {
    return widget.organizations.where((o) => o.campusId == campusId).length;
  }

  int _getFacultyOrgCount(String facultyId) {
    return widget.organizations.where((o) => o.facultyId == facultyId).length;
  }

  int _getProgramOrgCount(String programId) {
    return widget.organizations.where((o) => o.programId == programId).length;
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.userRole == 'dean') {
      ...
      if (deanFaculty == null) {
        ...
        final orgCount = _getFacultyOrgCount(deanFaculty.id);
                ...
                child: facultyPrograms.isEmpty
                    ...
                    : Column(
                        children: facultyPrograms.map((program) {
                          ...
                          final programCount = _getProgramOrgCount(program.id);

                          return _buildProgramRow(
                            program: program,
                            orgCount: programCount,
      ...
      if (headProgram == null) {
        ...
        final programCount = _getProgramOrgCount(headProgram.id);
      ...
      if (widget.campuses.isEmpty) {
        ...
        treeContent = ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final orgCount = _getCampusOrgCount(campus.id);
                    ...
                    child: campusFaculties.isEmpty
                        ...
                        : Column(
                            children: campusFaculties.map((faculty) {
                              ...
                              final facultyCount = _getFacultyOrgCount(faculty.id);
                              final facultyPrograms = widget.programs
        ...
        title: GestureDetector(
          ...
          child: Row(
            children: [
              ...
              _buildCountBadge(orgCount, isSelected, AppColors.primary),
            ],
          ),
        ),
      ),
        ...
        title: GestureDetector(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              _buildCountBadge(orgCount, isSelected, AppColors.accent),
            ],
          ),
        ),
      ),
        ...
        title: GestureDetector(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 8),
              _buildCountBadge(orgCount, isSelected, Colors.teal),
            ],
          ),
        ),
      ),
