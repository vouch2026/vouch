...
mixin _$OrganizationModel {
 ...
 String get id; String get name; String get code; String? get description;@JsonKey(name: 'logo_url') String? get logoUrl;@JsonKey(name: 'banner_url') String? get bannerUrl; String get status; String get type; String? get facultyProgram;@JsonKey(name: 'adviser_name') String? get adviserName;@JsonKey(name: 'program_head_name') String? get programHeadName;@JsonKey(name: 'dean_name') String? get deanName;@JsonKey(name: 'campus_id') String? get campusId;@JsonKey(name: 'faculty_id') String? get facultyId;@JsonKey(name: 'program_id') String? get programId; int get memberCount;@JsonKey(name: 'requires_adviser_signature') bool get requiresAdviserSignature;@JsonKey(name: 'requires_program_head_signature') bool get requiresProgramHeadSignature;@JsonKey(name: 'requires_faculty_dean_signature') bool get requiresFacultyDeanSignature;@JsonKey(name: 'allow_member_card_printing') bool get allowMemberCardPrinting;@JsonKey(name: 'restrict_clearance_request') bool get restrictClearanceRequest;@JsonKey(name: 'is_clearance_active') bool get isClearanceActive;@JsonKey(name: 'clearance_period_start') DateTime? get clearancePeriodStart;@JsonKey(name: 'clearance_period_end') DateTime? get clearancePeriodEnd;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
@useResult
$Res call({
 String id, String name, String code, String? description,@JsonKey(name: 'logo_url') String? logoUrl,@JsonKey(name: 'banner_url') String? bannerUrl, String status, String type, String? facultyProgram,@JsonKey(name: 'adviser_name') String? adviserName,@JsonKey(name: 'program_head_name') String? programHeadName,@JsonKey(name: 'dean_name') String? deanName,@JsonKey(name: 'campus_id') String? campusId,@JsonKey(name: 'faculty_id') String? facultyId,@JsonKey(name: 'program_id') String? programId, int memberCount,@JsonKey(name: 'requires_adviser_signature') bool requiresAdviserSignature,@JsonKey(name: 'requires_program_head_signature') bool requiresProgramHeadSignature,@JsonKey(name: 'requires_faculty_dean_signature') bool requiresFacultyDeanSignature,@JsonKey(name: 'allow_member_card_printing') bool allowMemberCardPrinting,@JsonKey(name: 'restrict_clearance_request') bool restrictClearanceRequest,@JsonKey(name: 'is_clearance_active') bool isClearanceActive,@JsonKey(name: 'clearance_period_start') DateTime? clearancePeriodStart,@JsonKey(name: 'clearance_period_end') DateTime? clearancePeriodEnd,@JsonKey(name: 'created_at') DateTime? createdAt
});
...
/// Create a copy of OrganizationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? code = null,Object? description = freezed,Object? logoUrl = freezed,Object? bannerUrl = freezed,Object? status = null,Object? type = null,Object? facultyProgram = freezed,Object? adviserName = freezed,Object? programHeadName = freezed,Object? deanName = freezed,Object? campusId = freezed,Object? facultyId = freezed,Object? programId = freezed,Object? memberCount = null,Object? requiresAdviserSignature = null,Object? requiresProgramHeadSignature = null,Object? requiresFacultyDeanSignature = null,Object? allowMemberCardPrinting = null,Object? restrictClearanceRequest = null,Object? isClearanceActive = null,Object? clearancePeriodStart = freezed,Object? clearancePeriodEnd = freezed,Object? createdAt = freezed,}) {
...
as bool,requiresProgramHeadSignature: null == requiresProgramHeadSignature ? _self.requiresProgramHeadSignature : requiresProgramHeadSignature // ignore: cast_nullable_to_non_nullable
...
as bool,restrictClearanceRequest: null == restrictClearanceRequest ? _self.restrictClearanceRequest : restrictClearanceRequest // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String code,  String? description, @JsonKey(name: 'logo_url')  String? logoUrl, @JsonKey(name: 'banner_url')  String? bannerUrl,  String status,  String type,  String? facultyProgram, @JsonKey(name: 'adviser_name')  String? adviserName, @JsonKey(name: 'program_head_name')  String? programHeadName, @JsonKey(name: 'dean_name')  String? deanName, @JsonKey(name: 'campus_id')  String? campusId, @JsonKey(name: 'faculty_id')  String? facultyId, @JsonKey(name: 'program_id')  String? programId,  int memberCount, @JsonKey(name: 'requires_adviser_signature')  bool requiresAdviserSignature, @JsonKey(name: 'requires_program_head_signature')  bool requiresProgramHeadSignature, @JsonKey(name: 'requires_faculty_dean_signature')  bool requiresFacultyDeanSignature, @JsonKey(name: 'allow_member_card_printing')  bool allowMemberCardPrinting, @JsonKey(name: 'restrict_clearance_request')  bool restrictClearanceRequest, @JsonKey(name: 'is_clearance_active')  bool isClearanceActive, @JsonKey(name: 'clearance_period_start')  DateTime? clearancePeriodStart, @JsonKey(name: 'clearance_period_end')  DateTime? clearancePeriodEnd, @JsonKey(name: 'created_at')  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrganizationModel() when $default != null:
return $default(_that.id,_that.name,_that.code,_that.description,_that.logoUrl,_that.bannerUrl,_that.status,_that.type,_that.facultyProgram,_that.adviserName,_that.programHeadName,_that.deanName,_that.campusId,_that.facultyId,_that.programId,_that.memberCount,_that.requiresAdviserSignature,_that.requiresProgramHeadSignature,_that.requiresFacultyDeanSignature,_that.allowMemberCardPrinting,_that.restrictClearanceRequest,_that.isClearanceActive,_that.clearancePeriodStart,_that.clearancePeriodEnd,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String code,  String? description, @JsonKey(name: 'logo_url')  String? logoUrl, @JsonKey(name: 'banner_url')  String? bannerUrl,  String status,  String type,  String? facultyProgram, @JsonKey(name: 'adviser_name')  String? adviserName, @JsonKey(name: 'program_head_name')  String? programHeadName, @JsonKey(name: 'dean_name')  String? deanName, @JsonKey(name: 'campus_id')  String? campusId, @JsonKey(name: 'faculty_id')  String? facultyId, @JsonKey(name: 'program_id')  String? programId,  int memberCount, @JsonKey(name: 'requires_adviser_signature')  bool requiresAdviserSignature, @JsonKey(name: 'requires_program_head_signature')  bool requiresProgramHeadSignature, @JsonKey(name: 'requires_faculty_dean_signature')  bool requiresFacultyDeanSignature, @JsonKey(name: 'allow_member_card_printing')  bool allowMemberCardPrinting, @JsonKey(name: 'restrict_clearance_request')  bool restrictClearanceRequest, @JsonKey(name: 'is_clearance_active')  bool isClearanceActive, @JsonKey(name: 'clearance_period_start')  DateTime? clearancePeriodStart, @JsonKey(name: 'clearance_period_end')  DateTime? clearancePeriodEnd, @JsonKey(name: 'created_at')  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _OrganizationModel():
return $default(_that.id,_that.name,_that.code,_that.description,_that.logoUrl,_that.bannerUrl,_that.status,_that.type,_that.facultyProgram,_that.adviserName,_that.programHeadName,_that.deanName,_that.campusId,_that.facultyId,_that.programId,_that.memberCount,_that.requiresAdviserSignature,_that.requiresProgramHeadSignature,_that.requiresFacultyDeanSignature,_that.allowMemberCardPrinting,_that.restrictClearanceRequest,_that.isClearanceActive,_that.clearancePeriodStart,_that.clearancePeriodEnd,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
class _OrganizationModel implements OrganizationModel {
  const _OrganizationModel({required this.id, required this.name, required this.code, this.description, @JsonKey(name: 'logo_url') this.logoUrl, @JsonKey(name: 'banner_url') this.bannerUrl, this.status = 'active', this.type = 'campus-based', this.facultyProgram, @JsonKey(name: 'adviser_name') this.adviserName, @JsonKey(name: 'program_head_name') this.programHeadName, @JsonKey(name: 'dean_name') this.deanName, @JsonKey(name: 'campus_id') this.campusId, @JsonKey(name: 'faculty_id') this.facultyId, @JsonKey(name: 'program_id') this.programId, this.memberCount = 0, @JsonKey(name: 'requires_adviser_signature') this.requiresAdviserSignature = false, @JsonKey(name: 'requires_program_head_signature') this.requiresProgramHeadSignature = false, @JsonKey(name: 'requires_faculty_dean_signature') this.requiresFacultyDeanSignature = false, @JsonKey(name: 'allow_member_card_printing') this.allowMemberCardPrinting = true, @JsonKey(name: 'restrict_clearance_request') this.restrictClearanceRequest = false, @JsonKey(name: 'is_clearance_active') this.isClearanceActive = false, @JsonKey(name: 'clearance_period_start') this.clearancePeriodStart, @JsonKey(name: 'clearance_period_end') this.clearancePeriodEnd, @JsonKey(name: 'created_at') this.createdAt});
...
@override@JsonKey(name: 'adviser_name') final  String? adviserName;
@override@JsonKey(name: 'program_head_name') final  String? programHeadName;
@override@JsonKey(name: 'dean_name') final  String? deanName;
...
@override@JsonKey(name: 'requires_program_head_signature') final  bool requiresProgramHeadSignature;
...
@override@JsonKey(name: 'restrict_clearance_request') final  bool restrictClearanceRequest;
