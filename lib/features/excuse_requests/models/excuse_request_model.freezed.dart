...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,studentId,eventId,reason,supportingDocumentUrl,status,rejectionReason,scopeType,scopeId,academicTermId,createdAt,updatedAt,reviewedByUserId,reviewedAt,submissionCount,studentName,studentIdNumber,eventName,reviewedByName]);

@override
String toString() {
  return 'ExcuseRequestModel(id: $id, studentId: $studentId, eventId: $eventId, reason: $reason, supportingDocumentUrl: $supportingDocumentUrl, status: $status, rejectionReason: $rejectionReason, scopeType: $scopeType, scopeId: $scopeId, academicTermId: $academicTermId, createdAt: $createdAt, updatedAt: $updatedAt, reviewedByUserId: $reviewedByUserId, reviewedAt: $reviewedAt, submissionCount: $submissionCount, studentName: $studentName, studentIdNumber: $studentIdNumber, eventName: $eventName, reviewedByName: $reviewedByName)';
}
...
as DateTime?,submissionCount: null == submissionCount ? _self.submissionCount : submissionCount // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _ExcuseRequestModel() when $default != null:
return $default(_that.id,_that.studentId,_that.eventId,_that.reason,_that.supportingDocumentUrl,_that.status,_that.rejectionReason,_that.scopeType,_that.scopeId,_that.academicTermId,_that.createdAt,_that.updatedAt,_that.reviewedByUserId,_that.reviewedAt,_that.submissionCount,_that.studentName,_that.studentIdNumber,_that.eventName,_that.reviewedByName);case _:
  return orElse();
