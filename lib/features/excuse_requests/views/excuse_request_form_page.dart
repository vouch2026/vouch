...
class _ExcuseRequestFormPageState extends ConsumerState<ExcuseRequestFormPage> {
  ...
  Future<void> _submitRequest() async {
    ...
    try {
      ...
      if (mounted) {
        // Refresh student excuse requests providers
  ...
  Widget _buildReasonTypeDropdown() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget _buildReasonJustificationField() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (isMobile) ...[
                          ...
                          const SizedBox(height: AppSpacing.lg),
                          _buildReasonTypeDropdown(),
                          const SizedBox(height: AppSpacing.lg),
                          _buildReasonJustificationField(),
                          const SizedBox(height: AppSpacing.lg),
                          ...
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              // Left column: Contextual summaries and uploads
                              Expanded(
                                flex: 5,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              // Right column: Input parameters and form actions
                              Expanded(
                                flex: 6,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
