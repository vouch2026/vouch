...
mixin _$ProgramModel {
 ...
 String get id; String get name; String get code;@JsonKey(name: 'faculty_id') String get facultyId;@JsonKey(name: 'program_head_id') String? get programHeadId; String? get programHeadName; String get status;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,code,facultyId,programHeadId,programHeadName,status,createdAt,updatedAt);
...
@useResult
$Res call({
 String id, String name, String code,@JsonKey(name: 'faculty_id') String facultyId,@JsonKey(name: 'program_head_id') String? programHeadId, String? programHeadName, String status,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of ProgramModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? code = null,Object? facultyId = null,Object? programHeadId = freezed,Object? programHeadName = freezed,Object? status = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
switch (_that) {
case _ProgramModel() when $default != null:
return $default(_that.id,_that.name,_that.code,_that.facultyId,_that.programHeadId,_that.programHeadName,_that.status,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _ProgramModel implements ProgramModel {
  const _ProgramModel({required this.id, required this.name, required this.code, @JsonKey(name: 'faculty_id') required this.facultyId, @JsonKey(name: 'program_head_id') this.programHeadId, this.programHeadName, this.status = 'active', @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt});
...
/// Create a copy of ProgramModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? code = null,Object? facultyId = null,Object? programHeadId = freezed,Object? programHeadName = freezed,Object? status = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
