...
class UserKpiCards extends ConsumerWidget {
  const UserKpiCards({super.key});
          ...
          return GridView.count(
            ...
            children: [
              _KpiCard(
                ...
                subtitle: '${stats.activeStudents} Active / ${stats.suspendedStudents} Suspended',
              ...
              _KpiCard(
                ...
                subtitle: '${stats.deansCount} Deans / ${stats.programHeadsCount} Program Heads',
                icon: Icons.school_outlined,
                color: Colors.orange,
                trend: stats.instructorTrend,
              ),
              _KpiCard(
                title: 'Governance',
                value: '${stats.totalOfficers}',
                subtitle: '${stats.activeGovernanceAccounts} Active Accounts',
                icon: Icons.admin_panel_settings_outlined,
                color: Colors.green,
                trend: stats.governanceTrend,
              ),
              _KpiCard(
                title: 'Memberships',
                value: '${stats.orgMembershipsCount}',
                subtitle: 'Total Organization Enrollees',
