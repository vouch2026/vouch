...
import '../providers/election_stats_provider.dart';

class ElectionKpiCards extends ConsumerWidget {
  const ElectionKpiCards({super.key});
          ...
          return GridView.count(
            ...
            children: [
              _KpiCard(
                ...
                subtitle: '${stats.upcomingElections} Upcoming / ${stats.completedElections} Done',
                icon: Icons.how_to_vote_rounded,
                color: Colors.blue,
              ),
              _KpiCard(
                title: 'Participation',
                value: '${stats.voterTurnoutRate}%',
                subtitle: '${stats.totalVotesCast} Votes / ${stats.registeredVoters} Voters',
                icon: Icons.people_outline_rounded,
                color: Colors.green,
                trend: stats.turnoutTrend,
              ),
              _KpiCard(
                title: 'Candidates',
              ...
              _KpiCard(
                ...
                subtitle: '${stats.activeComselecOfficials} Officials / ${stats.electionViolations} Violations',
