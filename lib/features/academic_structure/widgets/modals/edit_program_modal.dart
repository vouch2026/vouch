...
class _EditProgramModalState extends ConsumerState<EditProgramModal> {
  ...
  void initState() {
    ...
    _selectedHead = widget.program.programHeadId;
  }
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      String? bannerUrl = widget.program.bannerUrl;
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  if (_bannerImage == null && widget.program.bannerUrl != null && widget.program.bannerUrl!.isNotEmpty) ...[
                    ClipRRect(
                      borderRadius: BorderRadius.circular(8),
                      child: Image.network(
                        widget.program.bannerUrl!,
                        width: 80,
                        height: 48,
                        fit: BoxFit.cover,
                        errorBuilder: (context, error, stackTrace) => const Icon(Icons.broken_image_rounded, size: 48),
